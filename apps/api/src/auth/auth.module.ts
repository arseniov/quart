...
@Module({
  ...
  exports: [AuthService, BaAuthGuard, ValkeyService, MfaService, MfaGuard, MagicLinkService, PasswordResetService, PhoneOtpService, SessionService, SignOutService, MAILER],
})
